...
def loaded_actor(actor: CAGATMAPPOActor, config, path: Path, checkpoint_digit: str):
    ...
    return LoadedEvaluationActor(
        ...
        source_training_config_original_hash=config.config_hash,
        source_training_config_raw_snapshot_hash=config.config_hash,
        source_training_config_canonical_hash=config.config_hash,
